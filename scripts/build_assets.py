...
FPL_BASE_ROOT = os.path.abspath(os.path.join(os.path.join(PROJECT_ROOT),
                                            os.path.pardir, os.path.pardir,
                                            'libs', "fplbase"))
...
# Directory where unprocessed assets can be found.
SCHEMA_PATHS = [ os.path.join(FPL_BASE_ROOT, 'schemas') ]
...
FLATBUFFERS_CONVERSION_DATA = [
    FlatbuffersConversionData(
        schema=find_in_paths('fpl_common.fbs', SCHEMA_PATHS),
        input_files=[])
    ]
