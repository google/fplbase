...
#define FPL_KMOD_CTRL (FPL_KMOD_LCTRL | FPL_KMOD_RCTRL)
#define FPL_KMOD_SHIFT (FPL_KMOD_LSHIFT | FPL_KMOD_RSHIFT)
#define FPL_KMOD_ALT (FPL_KMOD_LALT | FPL_KMOD_RALT)
#define FPL_KMOD_GUI (FPL_KMOD_LGUI | FPL_KMOD_RGUI)
