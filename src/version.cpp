...
#define FPLBASE_STRING(X) FPLBASE_STRING_EXPAND(X)
...
///
static const FplBaseVersion kVersion = {
    FPLBASE_VERSION_MAJOR, FPLBASE_VERSION_MINOR, FPLBASE_VERSION_REVISION,
    "FPLBase Library " FPLBASE_STRING(FPLBASE_VERSION_MAJOR) "."
    FPLBASE_STRING(FPLBASE_VERSION_MINOR) "."
    FPLBASE_STRING(FPLBASE_VERSION_REVISION)};

const FplBaseVersion& Version() { return kVersion; }
